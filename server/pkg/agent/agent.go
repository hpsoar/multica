...
type Config struct {
	ExecutablePath string            // path to CLI binary (claude, codebuddy, codex, copilot, opencode, openclaw, hermes, pi, cursor, kimi, kiro-cli, agy, mimo, atomcode, qodercli, traecli, grok)
...
// Supported types: "claude", "codebuddy", "codex", "copilot", "opencode", "deveco", "openclaw", "hermes", "pi", "cursor", "kimi", "kiro", "antigravity", "mimo", "atomcode", "qoder", "traecli", "grok".
//
...
// add deveco, migration 179 to add grok, migration 202 to add mimo, and
// migration 203 to add atomcode): a custom runtime profile may only be based on
// a backend Multica officially supports.
...
func New(agentType string, cfg Config) (Backend, error) {
	...
	default:
		return nil, fmt.Errorf("unknown agent type: %q (supported: claude, codebuddy, codex, copilot, opencode, deveco, openclaw, hermes, pi, cursor, kimi, kiro, antigravity, mimo, atomcode, qoder, traecli, grok)", agentType)
	}
}
