...
// fixed reasoning-effort vocabulary. Codex, OpenCode, and MiMo are deliberately
...
// only empty; Codex, OpenCode, and MiMo accept well-formed tokens here because
...
func IsKnownThinkingValue(providerType, value string) bool {
	...
	if providerType == "codex" || providerType == "opencode" || providerType == "mimo" {
