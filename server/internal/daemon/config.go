...
type Config struct {
	...
	Agents                         map[string]AgentEntry // keyed by provider: claude, codebuddy, codex, copilot, opencode, openclaw, hermes, pi, cursor, kimi, kiro, antigravity, mimo, atomcode, qoder, traecli, grok
...
func LoadConfig(overrides Overrides) (Config, error) {
	...
	if len(agents) == 0 {
		return Config{}, fmt.Errorf("no agent CLI found: install claude, codebuddy, codex, copilot, opencode, deveco, openclaw, hermes, pi, cursor-agent, kimi, kiro-cli, agy, mimo, atomcode, qodercli, traecli, or grok and ensure it is on PATH")
	}
...
var defaultAgentCommandNames = []string{
	...
	"pi", "cursor-agent", "copilot", "kimi", "kiro-cli", "codebuddy", "mimo", "atomcode", "agy", "traecli", "grok",
}
